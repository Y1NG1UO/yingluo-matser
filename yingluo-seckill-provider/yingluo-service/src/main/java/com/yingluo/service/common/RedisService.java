package com.yingluo.service.common;
...
public class RedisService {
    ...
    public Boolean setSeckillEndFlag(long seckillId, String taskId) {
        return stringRedisTemplate.opsForValue().setIfAbsent("yingluo:seckill:end:notice" + seckillId + ":" + taskId, "1");
    }
    ...
    public Boolean clearSeckillEndFlag(long seckillId, String taskId) {
        return stringRedisTemplate.delete("yingluo:seckill:end:notice" + seckillId + ":" + taskId);
    }
